...
const Toggle = () => {
  ...
  return (
    ...
    <label className="relative inline-flex items-center gap-2">
        ...
        <div className={`absolute w-6 h-6 bg-white rounded-full inset-y-0 left-[110px] cursor-pointer" ${toggle ? 'translate-x-6' : 'translate-x-0'} transition-transform duration-300 cursor-pointer`}></div>
